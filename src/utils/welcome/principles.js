...
export function Principles() {
  return (
    <div class="principles">
      <section class="information-box-module_informationBox__QOoZN">
        <figure class="information-box-module_component__Fe90I">
          <img
            class="monday-storybook-principle_visual-element"
            src={clarity}
            alt=""
          />
        </figure>
        <h4 class="information-box-title-module_informationBoxTitle__Ue-Ii">
          Clarity
        </h4>
        <section class="information-box-module_description__0MwCB">
