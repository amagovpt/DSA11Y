...
const pt = {
  ...
  open_dropdown: "pressione para comprimir a nossa lista de aplicações e sítios web",
  close_dropdown: "pressione para expandir a nossa lista de aplicações e sítios web",
...
const en = {
  ...
  open_dropdown: "press to compress our list of applications and websites",
  close_dropdown: "press to expand our list of applications and websites",
