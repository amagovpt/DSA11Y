...
export const HeaderLogo = () => <Header description={"The web accessibility practices evaluator (WCAG 2.1)"} logo={useDarkMode() ? "/logo-dark.svg" : "/logo.svg"} darkTheme={useDarkMode()} />;
